...
var i_18686 = (0);
while(true){
if((i_18686 < arr.length)){
(arr[i_18686] = null);

var G__18687 = (i_18686 + (1));
i_18686 = G__18687;
continue;
} else {
}
...
var i_18701 = (self__.level + (1));
while(true){
if((i_18701 <= (new_level + (1)))){
(update[i_18701] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_18703 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_18703[i]));
} else {
x__$2.forward.push((((i < links_18703.length))?(links_18703[i]):null));
}

if((i < links_18703.length)){
(links_18703[i] = x__$2);
} else {
links_18703.push(x__$2);
}
...
var i_18717 = (0);
while(true){
if((i_18717 <= self__.level)){
var links_18718 = (update[i_18717]).forward;
if((x__$1 === (((i_18717 < links_18718.length))?(links_18718[i_18717]):null))){
(links_18718[i_18717] = (x__$1.forward[i_18717]));

var G__18719 = (i_18717 + (1));
i_18717 = G__18719;
continue;
} else {
var G__18720 = (i_18717 + (1));
i_18717 = G__18720;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__18750 = nx;
var G__18751 = (level__$1 - (1));
x = G__18750;
level__$1 = G__18751;
continue;
} else {
var G__18752 = x;
var G__18753 = (level__$1 - (1));
x = G__18752;
level__$1 = G__18753;
continue;
}
