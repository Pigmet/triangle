...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_22183 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_22183(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_22184 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_22184(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_22185 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_22185(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_22186 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_22186(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_22187 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_22187(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_22188 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_22188(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__22181,callback){
var map__22182 = p__22181;
var map__22182__$1 = cljs.core.__destructure_map(map__22182);
var input = map__22182__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22182__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22182__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
