...
triangle.core.init_vertex = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16557_SHARP_){
return triangle.calc.add.cljs$core$IFn$_invoke$arity$2(p1__16557_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(200),(200)], null));
...
var vec__16558 = (function (){var G__16561 = cljs.core.deref(triangle.core.state_vertex);
return (k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__16561) : k.call(null,G__16561));
})();
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16558,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16558,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16566),triangle$core$select_center_$_iter__16563(cljs.core.chunk_rest(s__16564__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16566),null);
}
} else {
var vec__16570 = cljs.core.first(s__16564__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),style(k)], null),cljs.core.name(k)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (vec__16570,k,v,s__16564__$2,temp__5804__auto__,style){
return (function (e){
var t = e.target.checked;
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(triangle.core.state_center,cljs.core.assoc,k,t);
});})(vec__16570,k,v,s__16564__$2,temp__5804__auto__,style))
], null)], null)], null)], null),triangle$core$select_center_$_iter__16563(cljs.core.rest(s__16564__$2)));
}
} else {
return null;
}
...
var map__16573 = cljs.core.deref(triangle.core.state_vertex);
var map__16573__$1 = cljs.core.__destructure_map(map__16573);
var a = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16573__$1,new cljs.core.Keyword(null,"a","a",-2123407586));
var b = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16573__$1,new cljs.core.Keyword(null,"b","b",1482224470));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16573__$1,new cljs.core.Keyword(null,"c","c",-1763192079));
var and__5043__auto__ = triangle.calc.triangle_QMARK_(a,b,c);
if(and__5043__auto__){
var G__16574 = cljs.core.deref(triangle.core.state_center);
return (k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__16574) : k.call(null,G__16574));
} else {
...
var map__16575 = cljs.core.deref(triangle.core.state_vertex);
var map__16575__$1 = cljs.core.__destructure_map(map__16575);
var a = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16575__$1,new cljs.core.Keyword(null,"a","a",-2123407586));
var b = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16575__$1,new cljs.core.Keyword(null,"b","b",1482224470));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16575__$1,new cljs.core.Keyword(null,"c","c",-1763192079));
var map__16576 = triangle.calc.circumcenter_data(a,b,c);
var map__16576__$1 = cljs.core.__destructure_map(map__16576);
var p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16576__$1,new cljs.core.Keyword(null,"p","p",151049309));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16576__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var vec__16577 = p;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16577,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16577,(1),null);
...
var map__16580 = cljs.core.deref(triangle.core.state_vertex);
var map__16580__$1 = cljs.core.__destructure_map(map__16580);
var a = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16580__$1,new cljs.core.Keyword(null,"a","a",-2123407586));
var b = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16580__$1,new cljs.core.Keyword(null,"b","b",1482224470));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16580__$1,new cljs.core.Keyword(null,"c","c",-1763192079));
var map__16581 = triangle.calc.incenter_data(a,b,c);
var map__16581__$1 = cljs.core.__destructure_map(map__16581);
var p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16581__$1,new cljs.core.Keyword(null,"p","p",151049309));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16581__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var vec__16582 = p;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16582,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16582,(1),null);
...
var map__16585 = cljs.core.deref(triangle.core.state_vertex);
var map__16585__$1 = cljs.core.__destructure_map(map__16585);
var a = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16585__$1,new cljs.core.Keyword(null,"a","a",-2123407586));
var b = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16585__$1,new cljs.core.Keyword(null,"b","b",1482224470));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16585__$1,new cljs.core.Keyword(null,"c","c",-1763192079));
var vec__16586 = triangle.calc.mul.cljs$core$IFn$_invoke$arity$2(((1) / (3)),triangle.calc.add.cljs$core$IFn$_invoke$arity$variadic(a,b,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c], 0)));
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16586,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16586,(1),null);
...
(triangle.core.ray.cljs$core$IFn$_invoke$arity$variadic = (function (start,dir,p__16592){
var map__16593 = p__16592;
var map__16593__$1 = cljs.core.__destructure_map(map__16593);
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__16593__$1,new cljs.core.Keyword(null,"color","color",1011675173),"black");
var half_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__16593__$1,new cljs.core.Keyword(null,"half?","half?",885850345),false);
...
/** @this {Function} */
(triangle.core.ray.cljs$lang$applyTo = (function (seq16589){
...
var map__16594 = cljs.core.deref(triangle.core.state_vertex);
var map__16594__$1 = cljs.core.__destructure_map(map__16594);
var a = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16594__$1,new cljs.core.Keyword(null,"a","a",-2123407586));
var b = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16594__$1,new cljs.core.Keyword(null,"b","b",1482224470));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16594__$1,new cljs.core.Keyword(null,"c","c",-1763192079));
var map__16595 = triangle.calc.orthocenter_data(a,b,c);
var map__16595__$1 = cljs.core.__destructure_map(map__16595);
var p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16595__$1,new cljs.core.Keyword(null,"p","p",151049309));
var rays = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16595__$1,new cljs.core.Keyword(null,"rays","rays",982661575));
var vec__16596 = p;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16596,(0),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [triangle.core.group,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [triangle.core.point,x,y,color], null)], null),(function (){var iter__5523__auto__ = (function triangle$core$orthocenter_$_iter__16599(s__16600){
return (new cljs.core.LazySeq(null,(function (){
var s__16600__$1 = s__16600;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__16600__$1);
if(temp__5804__auto__){
var s__16600__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__16600__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__16600__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__16602 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__16601 = (0);
while(true){
if((i__16601 < size__5522__auto__)){
var map__16603 = cljs.core._nth(c__5521__auto__,i__16601);
var map__16603__$1 = cljs.core.__destructure_map(map__16603);
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16603__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16603__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
cljs.core.chunk_append(b__16602,triangle.core.ray.cljs$core$IFn$_invoke$arity$variadic(start,dir,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"color","color",1011675173),color], 0)));

var G__16609 = (i__16601 + (1));
i__16601 = G__16609;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16602),triangle$core$orthocenter_$_iter__16599(cljs.core.chunk_rest(s__16600__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16602),null);
}
} else {
var map__16604 = cljs.core.first(s__16600__$2);
var map__16604__$1 = cljs.core.__destructure_map(map__16604);
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16604__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var dir = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16604__$1,new cljs.core.Keyword(null,"dir","dir",1734754661));
return cljs.core.cons(triangle.core.ray.cljs$core$IFn$_invoke$arity$variadic(start,dir,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"color","color",1011675173),color], 0)),triangle$core$orthocenter_$_iter__16599(cljs.core.rest(s__16600__$2)));
}
} else {
return null;
}
